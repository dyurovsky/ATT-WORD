...
Similar analyses of test trials showed broad success on Familiar, Novel, and ME trials across development. The 1--1.5 year-olds trended towards significance on Familiar trials ($t(26)  = 1.65$, $p = .11$), and were non-significantly in the correct direction on Novel and ME trials. At all other ages, children looked to the target at above-chance levels on all test trials (smallest $t(17)  = 2.10$, $p = .05$). These analyses are consistent with previous work showing the emergence of success on ME trials from approximately 16-18 months \cite<e.g.>{Halberda2006, Bion2012}.
