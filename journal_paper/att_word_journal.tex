...
How do children learn the meanings of their first words? Infants are situated in a social system from their first day of life, and some theories argue that they leverage this social information from the very outset of word learning \cite{Bloom1998}. For instance, infants follow direction of gaze by 6-months \cite{dentremont1997}, and are more likely to do so in the presence of other communicative signals \cite{Senju2008}. Individual differences in children's gaze-following predict differences in vocabulary development \cite{Brooks2008}. In addition, infants appear to be representing others' beliefs, and these representations affect their expectations by 12-months of age \cite{Vouloumanos2012}. Infants are thus tuned to social cues and could in principle already use these cues from the outset of word learning.

Yet some theories argue that early word learning---this process of mapping labels like ``ball'' and ``dog''---is primarily a perceptual process \cite{Vygotsky1978} and that infants learn words by mapping them onto salient objects in their learning environments \cite{Smith2000}. This proposal has a significant advantage in terms of parsimony, as the mechanisms it requires for the onset of word learning---perceptual orienting and associative mapping---are known to be robustly present in infants. In addition, the ecological context of language learning seems to support this sort of perceptually-driven learning. Early child-directed naming events are characterized by multi-modal synchrony: mothers move the objects they label in temporal synchrony with the labels they speak \cite{Gogate2000}, and the degree of synchrony predicts mapping for young infants \cite{Gogate2006}.

%% TRYING TO SET UP THE CAVEATS RIGHT BUT PERHAPS TOO OVER THE TOP?
NEW PARAGRAPHS: FIXME. Proponents of social views of word learning argue that perceptual views could at most only explain the learning of object labels, if that \cite<e.g., >{Bloom2001,Waxman2009}. In the broader process of vocabulary acquisition, simple object labels are overrepresented in early vocabulary \cite{caselli1995,Tardif2008}, but even young infants also learn many other kinds of words including predicate terms like verbs and adjectives and super- and sub-ordinate nouns \cite{Fenson1994,Bloom2001,Clark2003}. We are compelled by the argument that predicate terms are more difficult to learn via pure perceptual associations. Here we treat only object labels, recognizing both the importance of this case study and also that these labels do not represent the full extent of even very young children's vocabulary. 
